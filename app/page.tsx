...
// ────────────────────────────────────────────────────────────
// PDF Text Extractor (client-side, pdfjs-dist)
// ────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────
// HWP Text Extractor (client-side, hwp.js)
// ────────────────────────────────────────────────────────────
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center py-14 px-6 text-center">
                <div className="animate-float mb-5">
                  <div className="w-20 h-20 bg-white rounded-2xl shadow-apple-md flex items-center justify-center">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                      ...
                      <path d="M12 8h11l9 9v15a2 2 0 01-2 2H12a2 2 0 01-2-2V10a2 2 0 012-2z" fill="#0071E3" opacity="0.15"/>
                      <path d="M23 8l9 9h-7a2 2 0 01-2-2V8z" fill="#0071E3" opacity="0.4"/>
                ...
                <h2 className="text-lg font-bold text-apple-dark mb-1">
                  {isDragOver ? '여기에 놓아주세요 ✨' : '파일을 드래그하거나 클릭하세요'}
                </h2>
                ...
                <div className="mt-6 flex items-center gap-1.5 text-xs text-apple-secondary">
                  <span>🔒</span>
                  <span>파일은 브라우저에서만 처리되며 서버에 저장되지 않아 안전합니다</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-apple-blue-light rounded-xl flex items-center justify-center flex-shrink-0">
                  <svg className="animate-spin-slow" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path d="M10 2a8 8 0 100 16A8 8 0 0010 2z" stroke="#0071E3" strokeWidth="1.5" strokeDasharray="4 2"/>
                    <path d="M10 6v4l3 3" stroke="#0071E3" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                </div>
                <div>
                  <p className="font-bold text-apple-dark text-sm">AI 분석 중</p>
                  <p className="text-xs text-apple-secondary truncate max-w-xs">{fileName}</p>
                </div>
              </div>
